...
class RegisteredWebticket extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'registered:ticketweb';
    ...
    {
        $count = Ticketweb::where('sold_out', 'LIKE', '%s%' )->get()->count();
        $tickets = Ticketweb::where('sold_out', 'LIKE', '%s%' )->limit(10)->get();
